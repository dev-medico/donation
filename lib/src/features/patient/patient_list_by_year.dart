...
// class PatientListByYear extends ConsumerStatefulWidget {
//   static const routeName = "/patient_list_by_year";
//   final int year;
//   const PatientListByYear({Key? key, required this.year}) : super(key: key);

//   @override
//   ConsumerState<PatientListByYear> createState() => _PatientListByYearState();
// }

// class _PatientListByYearState extends ConsumerState<PatientListByYear> {
...
//     var donationData = ref.watch(donationListByYearProvider(widget.year));
...
//               data: (donations) {
//                 var results = ref.watch(patientByDonationsProvider(donations));
//                 return Column(
