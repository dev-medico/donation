...
class SpecialEventListTableScreen extends ConsumerStatefulWidget {
  static const routeName = "/special_event_list";
  final bool fromHome;
  const SpecialEventListTableScreen({Key? key, this.fromHome = false})
      : super(key: key);

  @override
  ConsumerState<SpecialEventListTableScreen> createState() =>
      _SpecialEventListTableScreenState();
}

class _SpecialEventListTableScreenState
    extends ConsumerState<SpecialEventListTableScreen> {
